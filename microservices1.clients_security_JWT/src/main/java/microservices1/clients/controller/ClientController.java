...
public class ClientController {
    ...
    private final String password = "Barney";

    @PostConstruct
    private void autoLogin(){ // configure the token in the header of the service calls
        clientService.provideAuthentication(username, password); //should be in a specific auth service
    }
