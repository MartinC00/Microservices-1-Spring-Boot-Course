...
public class ClientService {
    ...
    private final String urlService = "http://contact-list-service";

    public void callForNewContact(Person person){
        restTemplate.postForLocation(urlService +"/contactList", person);
    }

    public List<Person> callForContactList(){
        Person[] personArray = restTemplate.getForObject(urlService +"/contactList", Person[].class);
